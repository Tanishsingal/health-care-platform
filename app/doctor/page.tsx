...
import { Heart, Calendar, Users, FileText, Activity, Clock, AlertCircle, Plus, Bell } from "lucide-react"
        ...
        <Tabs defaultValue="today" className="space-y-6">
          ...
          <TabsContent value="calendar" className="space-y-6">
            <CalendarView 
              ...
              onAppointmentClick={(appointment) => router.push(`/doctor/patients/${appointment.patient_id}`)}
            />
          </TabsContent>
        </Tabs>
      </div>
