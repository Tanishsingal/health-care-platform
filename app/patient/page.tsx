    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
            ...
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                  {t('title', 'Patient Portal')}
                  <Badge variant="outline" className="text-xs border-blue-500 text-blue-600">रोगी</Badge>
                </h1>
                <p className="text-xs text-gray-600 dark:text-gray-400">{t('subtitle', 'Your Healthcare Dashboard')}</p>
              </div>
            </Link>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="border-2 hover:border-orange-400 transition-all hover:shadow-lg border-t-4 border-t-orange-500">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('upcomingAppointments', 'Upcoming Appointments')}</CardTitle>
              <Calendar className="h-5 w-5 text-orange-500" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-orange-600">{upcomingAppointments.length}</div>
          ...
          <Card className="border-2 hover:border-blue-400 transition-all hover:shadow-lg border-t-4 border-t-blue-500">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('medicalRecords', 'Medical Records')}</CardTitle>
              <FileText className="h-5 w-5 text-blue-500" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-blue-600">{recentRecords.length}</div>
              <p className="text-xs text-muted-foreground">
                {recentRecords[0]
          ...
          <Card className="border-2 hover:border-green-400 transition-all hover:shadow-lg border-t-4 border-t-green-500">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card className="border-2 hover:border-purple-400 transition-all hover:shadow-lg border-t-4 border-t-purple-500">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('healthStatus', 'Health Status')}</CardTitle>
              <Activity className="h-5 w-5 text-purple-500" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-green-600">{t('statusGood', 'Good')}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="border-2 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-white dark:from-gray-800 dark:to-gray-900">
            ...
            <Card className="mt-6 border-2 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-green-50 to-white dark:from-gray-800 dark:to-gray-900">
                <CardTitle className="text-xl">Active Prescriptions</CardTitle>
            ...
            <Card className="border-2 shadow-lg mt-6">
              <CardHeader className="bg-gradient-to-r from-purple-50 to-white dark:from-gray-800 dark:to-gray-900">
                <CardTitle className="text-xl">Lab Test Results</CardTitle>
          ...
          <div className="space-y-6">
            <Card className="border-2 shadow-lg border-t-4 border-t-blue-500">
            ...
            <Card className="border-2 shadow-lg border-t-4 border-t-green-500">
              <CardHeader className="bg-gradient-to-r from-green-50 to-white dark:from-gray-800 dark:to-gray-900">
